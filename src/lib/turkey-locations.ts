...
export const TURKEY_LOCATIONS: Record<string, string[]> = {
  ...
  "Ankara": [
    ...
    "Kalecik", "Keçiören", "Kızılcahamam", "Mamak", "Nallıhan", "Polatlı", "Pursaklar", "Sincan", "Şereflikoçhisar", "Yenimahalle"
  ],
  "Antalya": [
  ...
  "Bursa": [
    ...
    "Keles", "Kestel", "Mudanya", "Mustafakemalpaşa", "Nilüfer", "Orhaneli", "Orhangazi", "Osmangazi", "Yenişehir", "Yıldırım"
  ],
  "Çanakkale": [
  ...
  "Denizli": [
    ...
    "Çameli", "Çardak", "Çivril", "Güney", "Honaz", "Kale", "Merkezefendi", "Pamukkale", "Sarayköy", "Serinhisar", "Tavas"
  ],
  "Diyarbakır": [
  ...
  "Erzurum": [
    ...
    "Köprüköy", "Narman", "Oltu", "Olur", "Palandöken", "Pasinler", "Pazaryolu", "Şenkaya", "Tekman", "Tortum", "Uzundere", "Yakutiye"
  ],
  "Eskişehir": [
  ...
  "İstanbul": [
    ...
    "Sancaktepe", "Sarıyer", "Silivri", "Sultanbeyli", "Sultangazi", "Şile", "Şişli", "Tuzla", "Ümraniye", "Üsküdar", "Zeytinburnu"
  ],
  "İzmir": [
  ...
  "Kastamonu": [
    ...
    "Doğanyurt", "Hanönü", "İhsangazi", "İnebolu", "Küre", "Merkez", "Pınarbaşı", "Seydiler", "Şenpazar", "Taşköprü", "Tosya"
  ],
  "Kayseri": [
  ...
  "Manisa": [
    ...
    "Köprübaşı", "Kula", "Salihli", "Sarıgöl", "Saruhanlı", "Selendi", "Soma", "Şehzadeler", "Turgutlu", "Yunusemre"
  ],
  "Kahramanmaraş": [
  ...
  "Rize": [
    "Ardeşen", "Çamlıhemşin", "Çayeli", "Derepazarı", "Fındıklı", "Güneysu", "Hemşin", "İkizdere", "İyidere", "Kalkandere", "Pazar", "Merkez"
  ],
  "Sakarya": [
  ...
  "Samsun": [
    ...
    "Havza", "İlkadım", "Kavak", "Ladik", "Salıpazarı", "Tekkeköy", "Terme", "Vezirköprü", "Yakakent"
  ],
  "Siirt": [
  ...
  "Zonguldak": [
    "Alaplı", "Çaycuma", "Devrek", "Gökçebey", "Karadeniz Ereğli", "Kilimli", "Kozlu", "Merkez"
  ],
  "Aksaray": [
...
export const TURKISH_CITIES: string[] = Object.keys(TURKEY_LOCATIONS).sort((a, b) =>
  a.localeCompare(b, "tr")
);

export function getDistrictsForCity(cityName: string): string[] {
  if (!cityName) return [];
  const found = Object.keys(TURKEY_LOCATIONS).find(
    (c) => c.toLowerCase() === cityName.trim().toLowerCase()
  );
  if (found && TURKEY_LOCATIONS[found]) {
    return [...TURKEY_LOCATIONS[found]].sort((a, b) => a.localeCompare(b, "tr"));
  }
  return [];
}
